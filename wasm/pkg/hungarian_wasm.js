 ...
 * @returns {Int32Array}
 */
export function hungarian_algorithm(cost_matrix, num_rows, num_cols) {
    const ptr0 = passArrayF64ToWasm0(cost_matrix, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.hungarian_algorithm(ptr0, len0, num_rows, num_cols);
...
async function __wbg_init(module_or_path, memory) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('hungarian_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports(memory);
