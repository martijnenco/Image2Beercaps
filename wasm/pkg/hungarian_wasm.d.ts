 ...
 */
export function hungarian_algorithm(cost_matrix: Float64Array, num_rows: number, num_cols: number): Int32Array;
...
export interface InitOutput {
  readonly hungarian_algorithm: (a: number, b: number, c: number, d: number) => [number, number];
